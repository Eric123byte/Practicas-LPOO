...
public class DesarrolladorMorales extends EmpleadoEM{
    
    private double bono;
    private int evaluacion;
    private String descripcion;
    private boolean promovible = false;
    private String puesto = "Desarrollador Junior";

    public DesarrolladorMorales() {
    }
    
    public DesarrolladorMorales(String nombre, int edad, String telefono, String correo, double sueldo, int aniosEnEmpresa) {
        setNombre(nombre);
        setEdad(edad);
    ...
    public void promover() {
        if(promovible == true && puesto.contentEquals("Desarrollador Junior")){
            System.out.println("A sido ascendido a desarrollador senior.");
